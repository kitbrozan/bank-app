...
export function MyProgramCard() {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-gold/30 bg-card/60 p-5 backdrop-blur-xl">
      <div
        aria-hidden
      ...
      <p className="text-2xl font-semibold text-foreground">8,420 pts</p>
