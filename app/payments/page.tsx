...
function TransactionCard({ tx }: { tx: Transaction }) {
  ...
  return (
    <div
      ...
      className="group relative flex items-center gap-4 rounded-2xl border border-border/40 bg-card/40 p-4 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:bg-card/60 hover:shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-gold/5 sm:p-5"
    >
      {/* Avatar */}
      <div
...
function StatCard({ label, value, change, positive }: { label: string; value: string; change: string; positive: boolean }) {
  return (
    <div className="rounded-2xl border border-border/40 bg-card/40 p-5 backdrop-blur-xl transition-all duration-300 hover:bg-card/60">
    ...
    <main className="bg-aurora min-h-screen w-full">
      <div className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 lg:py-12">
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <input
                ...
                className="h-10 w-full rounded-full border border-border bg-card/50 pl-9 pr-4 text-sm text-foreground placeholder:text-muted-foreground/50 backdrop-blur outline-none ring-0 transition-all focus:border-gold/30 focus:ring-1 focus:ring-gold/20 sm:w-64"
              />
            </div>
            <button
              type="button"
            ...
            <button
              type="button"
              className="flex items-center gap-2 rounded-full bg-gold/15 px-4 py-2 text-xs font-medium text-gold ring-1 ring-gold/30 transition-all hover:bg-gold/25"
            >
        ...
        <div className="mt-8 flex justify-center">
          <button
            type="button"
            className="rounded-full border border-border bg-card/40 px-6 py-2.5 text-sm font-medium text-muted-foreground backdrop-blur transition-all hover:bg-card/60 hover:text-foreground"
          >
            Load more
          </button>
        </div>
